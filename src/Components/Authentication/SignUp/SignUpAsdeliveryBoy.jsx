...
import deliveryBoyBg from '../../../Images/delivery2.jpg'; // Import the background image

function SignUpAsDeliveryBoy() {
  const navigate = useNavigate(); // Initialize the useNavigate hook

  return (
    <div
      className="h-screen bg-cover bg-center flex justify-center items-center"
      style={{ backgroundImage: `url(${deliveryBoyBg})` }}
    >
      {/* Card container */}
...
export default SignUpAsDeliveryBoy;
